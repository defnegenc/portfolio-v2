          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            {[
              ...
              },
              {
                ...
                body: 'Interface design has always operated on the premise of the "universal user." Someone with ADHD using a habit tracker designed for neurotypical attention doesn\'t have a personal failing — they have an interface that was never designed for them. A student with dyslexia hitting a wall in a reading app built around a single interaction mode runs into the same problem. This rigidity isn\'t only a challenge for marginalized populations. Even the so-called ideal user finds themselves constrained by interfaces that assume singular contexts and single interaction modes. AI combined with ubiquitous computing suggests we\'re no longer bound to this model. Systems can now understand semantic goals, process natural language intentions, and adapt to how someone is engaging with information in real time. Flexible interfaces are no longer a research aspiration — they\'re an engineering problem.',
              },
              {
